...
item-a = Item.create!(
  user: User.first.id,
  title: "Bicycle",
  description: "Stylish purple bike that will get you to the top! Framesize 49cmProfessionally checked and serviced by a top-level bike mechanic, incl. 3 months technical guarantee.",
